 ...
 */
public class ModeloCirconDaoimplement extends ImplDao<RolModuloPermiso, Long> implements RolModuloPermisoDao, Serializable {

    EntityManager em = getEmf().createEntityManager();
    private static ModeloCirconDaoimplement RMPDao = new ModeloCirconDaoimplement();
    private static ModeloDaoimplement MoDao = new ModeloDaoimplement();
